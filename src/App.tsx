				...
				<Container>
					{!!periods && (
						<>
							...
							<PeriodSlider sliderId='historialDates' periods={periods} title={"Исторические даты"} />
							<PeriodSlider sliderId='histoicalDates' periods={periods} title={"Исторические даты"} />
						</>
					)}
				</Container>
			</Section>
